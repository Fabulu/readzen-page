...
/**
 * Drop the in-memory layer only, leaving sessionStorage intact.
 * Used by tests that simulate a fresh tab/navigation where the next
 * `get` should rehydrate from sessionStorage rather than hit the
 * still-warm memory cache.
 */
